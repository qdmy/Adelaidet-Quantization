...
class MobileNetV3Controller(nn.Module):
    def __init__(self, constraint_list=[10.0, 12.5, 15.0, 17.5, 20.0], n_superclass=20, n_unit=N_UNITS,
                 depths=DEPTHS, kernel_sizes=KERNEL_SIZES, expand_ratios=EXPAND_RATIOS,
                 hidden_size=64, batch_size=1, device="cpu"):
        super(MobileNetV3Controller, self).__init__()
        self.n_unit = n_unit
        self.depths = depths
