...
from detectron2_ofa.structures import ImageList
from detectron2_ofa.modeling.postprocessing import detector_postprocess, sem_seg_postprocess
from detectron2_ofa.modeling.proposal_generator import build_proposal_generator
from detectron2_ofa.modeling.backbone import build_backbone
from detectron2_ofa.modeling.meta_arch.panoptic_fpn import combine_semantic_and_instance_outputs
from detectron2_ofa.modeling.meta_arch.build import META_ARCH_REGISTRY
from detectron2_ofa.modeling.meta_arch.blendmask.basis_module import build_basis_module
from detectron2_ofa.modeling.meta_arch.semantic_seg import build_sem_seg_head

from .blender import build_blender
from .top_module import build_top_module

__all__ = ["SmalBlend"]


@META_ARCH_REGISTRY.register()
class SmalBlend(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        self.top_module = build_top_module(cfg, attn_len, self.backbone.output_shape())
    ...
    def forward(self, batched_inputs):
        ...
        top_feats = self.top_module(proposals, gt_instances)
        detector_results, detector_losses = self.blender(
            basis_out["bases"], top_feats, proposals, gt_instances)
