...
_C.MODEL = CN()
_C.MODEL.DROPOUT_P = 0
# enable FP16 training
_C.MODEL.fp16 = False
_C.MODEL.apex_sync_bn = False

# args for popcount-net
_C.MODEL.CLS = CN()
_C.MODEL.CLS.KEYWORD = 'imagenet,origin,preBN,bacs,custom-update'
_C.MODEL.CLS.VERBOSE = False
...
_C.MODEL.QUANTIZATION.shortcut_fm_bit = 4.0
_C.MODEL.QUANTIZATION.first_last_fm_bit = 4.0
...
_C.MODEL.QUANTIZATION.shortcut_wt_bit = 4.0
_C.MODEL.QUANTIZATION.first_last_wt_bit = 4.0
...
_C.MODEL.QUANTIZATION.NOT_SHARED_HEAD = False
_C.MODEL.QUANTIZATION.NOT_SHARED_NORM_HEAD = False
_C.MODEL.QUANTIZATION.QUAN_TYPE = "dorefa_clip"
_C.MODEL.QUANTIZATION.wt_T = 3.0
_C.MODEL.QUANTIZATION.fm_T = 3.0
_C.MODEL.QUANTIZATION.QUANTIZE_FIRST_AND_LAST = False
_C.MODEL.QUANTIZATION.MERGE_BN = False
_C.MODEL.QUANTIZATION.QUANTIZE_ONE_HEAD = False
_C.MODEL.QUANTIZATION.QUANTIZE_HEAD = 0
...
# superclass number
_C.DATASETS.SUPERCLASS_NUM = 11 # 12
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
# Number of classes to skip in the semantic segmentation head
_C.MODEL.SEM_SEG_HEAD.SKIP_CLASSES = 0
...
_C.MODEL.SEM_SEG_HEAD.INS_LOSS_WEIGHT = 0.0
...
_C.MODEL.RETINANET.SHARED_NORM = True
_C.MODEL.RETINANET.NOT_SHARED_HEAD = 0.1
...
_C.MODEL.FCOS.SHARED_NORM = True
_C.MODEL.FCOS.NOT_SHARED_HEAD = False
...
_C.MODEL.BASIS_MODULE.VISUALIZE = False
...
# SmalMask Options
# ---------------------------------------------------------------------------- #
_C.MODEL.SMALMASK = CN()
_C.MODEL.SMALMASK.MASK_SIZE = 28
_C.MODEL.SMALMASK.POOLER_RESOLUTION = 5
_C.MODEL.SMALMASK.POOLER_SAMPLING_RATIO = 1
_C.MODEL.SMALMASK.POOLER_TYPE = "ROIAlignV2"
_C.MODEL.SMALMASK.CANONICAL_SIZE_BOX = 64
_C.MODEL.SMALMASK.CANONICAL_SIZE_MASK = 128
_C.MODEL.SMALMASK.CANONICAL_LEVEL = 3

# ---------------------------------------------------------------------------- #
# SmalBlend Options
# ---------------------------------------------------------------------------- #
_C.MODEL.SMALBLEND = CN()
_C.MODEL.SMALBLEND.POOLER_RESOLUTION = 5
_C.MODEL.SMALBLEND.IN_FEATURES = ["p3", "p4", "p5", "p6", "p7"]
_C.MODEL.SMALBLEND.POOLER_SAMPLING_RATIO = 1
_C.MODEL.SMALBLEND.POOLER_TYPE = "ROIAlignV2"
_C.MODEL.SMALBLEND.CANONICAL_LENGTHS = [64, 48, 96]
_C.MODEL.SMALBLEND.CANONICAL_LEVEL = 3
...
_C.SOLVER.DOUBLE_FORWARD_SCALE_FACTOR = 0.5
...
# and access it with:
#
# from detectron2_ofa.config import global_cfg
