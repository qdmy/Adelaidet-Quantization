...
from detectron2_ofa.data.datasets.coco import convert_to_coco_json
from detectron2_ofa.structures import Boxes, BoxMode, pairwise_iou
from detectron2_ofa.utils.logger import create_small_table
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        class_to_superclass_idx = self._metadata.class_to_superclass_idx # 里面保存的是每个类对应的superclass idx
