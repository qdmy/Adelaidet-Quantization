...
from detectron2.engine import DefaultTrainer, default_argument_parser, default_setup, hooks, launch, DefaultTrainerDoubleForward
...
class Trainer(DefaultTrainerDoubleForward):
    """
