...
python tools/train_net.py --num-gpus 4 --config-file configs/FCOS-COCO-Detection/fcos_R_50_1x-Full-BN_SyncBN_dorefa_clip3bit.yaml --dist-url tcp://127.0.0.1:62211