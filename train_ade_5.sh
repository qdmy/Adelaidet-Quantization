...
#SBATCH --mem=100GB                                              # memory pool for all cores (here set to 16 GB)
...
python tools/train_net.py --num-gpus 2 --config-file configs/FCOS-COCO-Detection/fcos_R_18_1x-Full_SyncBN_dorefa_clip_backbone_fpn.yaml --dist-url tcp://127.0.0.1:62219